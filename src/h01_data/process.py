...
from h01_data.processor import \
    ...
    ShuffledBertProcessor, ShuffledAlbertProcessor, ShuffledRobertaProcessor
...
def get_data_processor(representation, args):
    ...
    elif representation == 'bertshuffled':
        processor = ShuffledBertProcessor()
    elif representation == 'albert':
        processor = AlbertProcessor()
    elif representation == 'albertshuffled':
        processor = ShuffledAlbertProcessor()
    elif representation == 'roberta':
        processor = RobertaProcessor()
    elif representation == 'robertashuffled':
        processor = ShuffledRobertaProcessor()
